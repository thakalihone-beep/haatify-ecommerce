<header class="bg-[#131921] text-white shadow-md py-3">
    ...
    <nav>
        ...
        <div class="lg:flex items-center w-full h-14 px-8 lg:px-12 gap-1">
            ...
            <!-- ==================== LOGO ==================== -->
            <div
                class="flex items-center h-12 px-3 border border-transparent
            ...
            <div
                class="flex items-center h-12 px-3 border border-transparent
                       hover:border-white rounded-sm cursor-pointer whitespace-nowrap">
            ...
            <div class="flex flex-1 h-10 mx-2 min-w-0">
                ...
                <div class="relative group shrink-0">
                    ...
                    <button
                        ...
                        <!-- Arrow -->
                        <i
                            class="fa-solid fa-chevron-down text-[9px] text-gray-500
                    ...
                    <div
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div
                                            class="w-8 h-8 rounded-md
                                                   bg-gray-100
                                                   group-hover/item:bg-orange-100
                                                   flex items-center justify-center
                                                   transition">

                                            <i
                                                class="fa-solid fa-tag text-xs
                                                       text-gray-500
                        ...
                        <div
                            ...
                            <p class="text-xs text-gray-500 text-center">
                                Explore all Haatify categories
                            </p>
                ...
                <!-- ==================== SEARCH FORM ==================== -->
                <form action="{{ route('search') }}" method="GET" class="flex flex-1 min-w-0">
            ...
            <!-- ==================== CART ==================== -->
            <div
                class="flex items-center h-12 px-3 py-1
                       border border-transparent
                       hover:border-white
                       rounded-sm
                       cursor-pointer
